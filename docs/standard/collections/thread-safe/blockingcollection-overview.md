...
## <a name="cancelling-add-and-take-operations"></a>追加操作と取得操作の取り消し  
 ...
 キャンセル サポートを追加する方法の例については、「[方法: BlockingCollection の項目を個別に追加および取得する](how-to-add-and-take-items.md)」の 2 つ目の例を参照してください。  

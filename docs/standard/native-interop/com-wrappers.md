...
- [.NET Framework における高度な COM 相互運用性](/previous-versions/dotnet/netframework-4.0/bd9cdfyx(v=vs.100))
- [ランタイム呼び出し可能ラッパー](runtime-callable-wrapper.md)
- [COM 呼び出し可能ラッパー](com-callable-wrapper.md)
- [.NET Framework 内で標準ラッパーをカスタマイズする](/previous-versions/dotnet/netframework-4.0/h7hx9abd(v=vs.100))
- [方法: .NET Framework 内でランタイム呼び出し可能ラッパーをカスタマイズする](/previous-versions/dotnet/netframework-4.0/56kh4hy7(v=vs.100))

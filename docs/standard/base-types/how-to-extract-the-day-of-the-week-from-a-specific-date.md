...
## <a name="extract-a-number-indicating-the-day-of-the-week"></a>曜日を表す数値を抽出する
...
## <a name="extract-the-abbreviated-weekday-name"></a>曜日の省略名を抽出する
...
## <a name="extract-the-full-weekday-name"></a>曜日の完全な名前を抽出する

...
---
# <a name="member-membername-implicitly-defines-a-member-implicitmembername-which-has-the-same-name-as-a-type-parameter"></a>メンバー '\<membername>' は、型パラメーターと同じ名前のメンバー '\<implicitmembername>' を暗黙的に定義します

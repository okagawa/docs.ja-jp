...
[Operator Statement](../language-reference/statements/operator-statement.md) には [Public](../language-reference/modifiers/public.md) キーワードが含まれていません。  
 ...
 プロシージャには `Operator` との両方のキーワードとの両方が必要です。また、 `Public` 変換演算子にも、[拡大](../language-reference/modifiers/widening.md)または[縮小](../language-reference/modifiers/narrowing.md)のキーワードが必要です。 [](../language-reference/modifiers/shared.md)  

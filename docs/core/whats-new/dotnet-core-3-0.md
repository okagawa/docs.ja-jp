...
> [!IMPORTANT]
> Windows と macOS はまだ **TLS 1.3** をサポートしていません。
...
- [バージョン 2.2 から 3.0 への破壊的変更を確認する。](../compatibility/3.0.md)

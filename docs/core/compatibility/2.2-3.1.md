...
---
# <a name="breaking-changes-for-migration-from-version-22-to-31"></a>バージョン 2.2 から 3.1 への移行の破壊的変更

.NET Core、ASP.NET Core、または EF Core のバージョン 2.2 からバージョン 3.1 に移行する場合、この記事の一覧にある破壊的変更がご使用のアプリに影響する可能性があります。

...
- [XmlSerializer を使用してシリアル化する方法 (C#)](../../standard/linq/serialize-xmlserializer.md)
- [方法: XmlSerializer を使用してシリアル化する (Visual Basic)](../../standard/linq/serialize-xmlserializer.md)

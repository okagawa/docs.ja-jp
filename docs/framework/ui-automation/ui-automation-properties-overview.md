...
## <a name="property-identifiers"></a>プロパティ識別子  
 ...
 次の表は、id を含むクラスによってプロパティを分類して <xref:System.Windows.Automation.AutomationProperty> います。  
...
|<xref:System.Windows.Automation.AutomationElement.CultureProperty>|該当なし|  

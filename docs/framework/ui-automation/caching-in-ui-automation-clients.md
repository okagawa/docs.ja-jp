...
description: .NET の UI オートメーションクライアントでのキャッシュに関する詳細を取得します。 キャッシュは、データのプリフェッチとして定義されます。
ms.date: 03/30/2017
helpviewer_keywords:
...
- [FetchTimer サンプル](/previous-versions/dotnet/netframework-3.5/ms771456(v=vs.90))

...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-48"></a>.NET Framework 4.5.2 から 4.8 への移行に関する変更の再ターゲット

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

.NET Framework 4.5.2 から 4.8 に移行する場合は、アプリに影響する可能性があるアプリケーションの互換性の問題に関する次のトピックを確認してください。

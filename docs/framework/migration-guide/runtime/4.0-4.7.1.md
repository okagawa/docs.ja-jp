...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-471"></a>.NET Framework 4.0 から 4.7.1 への移行に関するランタイム変更

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

.NET Framework 4.0 から 4.7.1 に移行する場合は、アプリに影響する可能性があるアプリケーションの互換性の問題に関する次のトピックを確認してください。

...
1. Company X の従業員が Request for Proposal (RFP) を作成します。  
    ...
    2. 従業員は、提案を送信するために招待するベンダーを選択します。  

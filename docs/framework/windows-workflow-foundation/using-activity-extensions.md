...
1. Visual Studio 2010 を開きます。 [ **新規**]、[ **プロジェクト**] を選択します。 [ **Visual C#** ] ノードで、[ **ワークフロー**] を選択します。  テンプレートの一覧から [ **ワークフローコンソールアプリケーション** ] を選択します。 プロジェクトに `Extensions` という名前を付けます。 **[OK]** をクリックしてプロジェクトを作成します。

2. `using`Program.cs 名前空間のステートメント **を、** ファイルに追加します。

...
- [C# および Visual Basic での Windows ランタイム コンポーネントの作成](/previous-versions/br230301(v=vs.110))
- [Winmdexp.exe のエラー メッセージ](winmdexp-exe-error-messages.md)
- [ビルド ツール、配置ツール、および構成ツール (.NET Framework)](/previous-versions/dotnet/netframework-4.0/dd233108(v=vs.100))

...
11. `InvokeCalculatorService` メソッド内で、`CalculatorServiceClient` クラスのインスタンスを作成します。 このクラスは、 [自己ホスト](../samples/self-host.md) のサンプルで定義されています。 これは、Svcutil.exe を使用して生成されました。  

...
|許可されます。|true|WS-AT|トランザクションは、相互運用可能な WS-AT 形式でフローさせることができます。|  
|許可されます。|true|OleTransactions|トランザクションは、WCF OleTransactions 形式でフローさせることができます。|  
|許可されます。|false|任意の値|トランザクションは送信されません。|  

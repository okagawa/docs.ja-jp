...
|CannotPerformS4UImpersonationOnPlatform|指定されたコントラクトの指定されたバインディングは、Windows Server 2003 以降のバージョンの Windows でのみ偽装をサポートします。 SspiNegotiated 認証とキャンセルを有効にした SecureConversation を使用したバインディングを使用してください。|

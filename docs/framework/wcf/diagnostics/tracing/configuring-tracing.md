...
## <a name="configuring-trace-listeners-to-consume-traces"></a>トレースを使用するためのトレース リスナーの構成  
 ...
 また、トレース リスナーはプログラムによって構成することもできます。 詳細については、「 [方法: トレースリスナーを作成および初期化](../../../debug-trace-profile/how-to-create-and-initialize-trace-listeners.md) する」および「 [カスタム TraceListener の作成](/archive/msdn-magazine/2006/april/clr-inside-out-extending-system-diagnostics)」を参照してください。  
...
- [カスタム TraceListener の作成](/archive/msdn-magazine/2006/april/clr-inside-out-extending-system-diagnostics)
